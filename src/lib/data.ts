...
export const employees: Employee[] = [
  ...
  { id: 'e11', name: 'Sonia Sboui', email: 'sonia.sboui@contractor.atolls.com', phoneNumber: '+1-202-555-0100', avatarUrl: 'https://picsum.photos/seed/avatar11/100/100', role: 'Employee', departmentId: 'd1', status: 'active', startDate: '2020-01-01' },
